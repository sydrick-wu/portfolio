  ...
  return (
    <section className="portrait-editorial section-pad" aria-label={language === "en" ? "Personal photographs" : "个人影像"}>
      ...
      <div className="portrait-editorial-grid">
        <EditorialPhoto name="portrait" language={language} caption={language === "en" ? "Amsterdam · Along the canals" : "阿姆斯特丹 · 运河边"} className="portrait-editorial-main" sizes="(max-width: 720px) 90vw, 52vw" />
